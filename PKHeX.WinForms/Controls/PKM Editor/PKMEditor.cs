...
namespace PKHeX.WinForms.Controls
{
    public partial class PKMEditor : UserControl
    {
        ...
        public void ClickMoves(object sender, EventArgs e)
        {
            UpdateLegality(skipMoveRepop: true);
        ...
        public void UpdateRandomPID(object sender, EventArgs e)
        {
            if (pkm.Format < 3)
                return;
            if (fieldsLoaded)
        ...
        public void UpdateShinyPID(object sender, EventArgs e)
        {
