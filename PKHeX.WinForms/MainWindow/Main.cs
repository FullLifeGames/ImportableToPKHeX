    ...
    public partial class Main : Form
    {
        ...
        public void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (savExtraction)
            {
                ...
                CB_BoxSelect.SelectedIndex = minB - 1;
            }
            ...
            foreach (Pokemon p in pkms)
            {
                ...
                if (!special)
                {
                    ...
                    {
                        mainMenuOpen(pokegenfolder + "testworkup.ek6");
                    }
                ...
                if (p.level != null && int.Parse(TB_MetLevel.Text) > int.Parse(p.level))
                {
                    TB_MetLevel.Text = p.level;
                }
                ...
                i = null;
                foreach (ComboItem items in CB_HeldItem.Items)
                {
                ...
                {
                    i = null;
                    foreach (ComboItem items in CB_Nature.Items)
                    {
                ...
                i = null;
                foreach (ComboItem items in CB_Move1.Items)
                {
                ...
                i = null;
                foreach (ComboItem items in CB_Move2.Items)
                {
                ...
                i = null;
                foreach (ComboItem items in CB_Move3.Items)
                {
                ...
                i = null;
                foreach (ComboItem items in CB_Move4.Items)
                {
            ...
            if (!singleFiles && !savExtraction)
            {
                ...
                File.WriteAllBytes(extractPath + "boxdata.bin", SAV.getBoxBin(CB_BoxSelect.SelectedIndex));
            }
        ...
        private void clickExportSAVCustomized(string path)
        {
            ...
            File.WriteAllBytes(path, SAV.Write(dsv));
            SAV.Edited = false;
        }
