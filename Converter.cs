    ...
    public partial class Converter : Form
    {
        ...
        private void convert_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Main form = new Main(pokemon, textBox2.Text, radioButton1.Checked, textBox3.Text, radioButton3.Checked, maskedTextBox1.Text, maskedTextBox2.Text, checkBox1.Checked, gen7Check.Checked, CB_Native.Checked);
